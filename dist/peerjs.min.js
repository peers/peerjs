...
"use strict";var t=this&&this.__extends||function(){var t=function(e,s){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var s in e)e.hasOwnProperty(s)&&(t[s]=e[s])})(e,s)};return function(e,s){function o(){this.constructor=e}t(e,s),e.prototype=null===s?Object.create(s):(o.prototype=s.prototype,new o)}}();exports.__esModule=!0;var e=require("./util"),s=require("eventemitter3"),o=require("./enums"),n=function(){function t(t,e){this.streamIndex=t,this._httpUrl=e,this.index=1,this.buffer=[],this._xmlHttpRequest=new XMLHttpRequest,this._onError=function(t){},this._onSuccess=function(t){};var s=this;this._xmlHttpRequest.onerror=function(){s._onError(s)},this._xmlHttpRequest.onreadystatechange=function(){s.needsClearPreviousRequest()?s.clearPreviousRequest():s.isSuccess()&&s._onSuccess(s)}}return Object.defineProperty(t.prototype,"onError",{set:function(t){this._onError=t},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"onSuccess",{set:function(t){this._onSuccess=t},enumerable:!0,configurable:!0}),t.prototype.send=function(){this._xmlHttpRequest.open("post",this._httpUrl+"/id?i="+this.streamIndex,!0),this._xmlHttpRequest.send(null)},t.prototype.abort=function(){this._xmlHttpRequest.abort(),this._xmlHttpRequest=null},t.prototype.isSuccess=function(){return this._xmlHttpRequest.readyState>2&&200===this._xmlHttpRequest.status&&!!this._xmlHttpRequest.responseText},t.prototype.needsClearPreviousRequest=function(){return 2===this._xmlHttpRequest.readyState&&!!this.previousRequest},t.prototype.clearPreviousRequest=function(){this.previousRequest&&(this.previousRequest.abort(),this.previousRequest=null)},t.prototype.getMessages=function(){return this._xmlHttpRequest.responseText.split("\n")},t.prototype.hasBufferedIndices=function(){return this.buffer.length>0},t.prototype.popBufferedIndex=function(){return this.buffer.shift()},t.prototype.pushIndexToBuffer=function(t){this.buffer.push(t)},t}(),i=function(s){function i(t,e,o,n,i,r){void 0===r&&(r=o);var u=s.call(this)||this;u.HTTP_TIMEOUT=25e3,u._disconnected=!1,u._messagesQueue=[];var p=t?"https://":"http://",c=t?"wss://":"ws://";return u._httpUrl=p+e+":"+o+n+i,u._wsUrl=c+e+":"+r+n+"peerjs?key="+i,u}return t(i,s),i.prototype.start=function(t,e){this._id=t,this._httpUrl+="/"+t+"/"+e,this._wsUrl+="&id="+t+"&token="+e,this._startXhrStream(),this._startWebSocket()},i.prototype._startWebSocket=function(){if(!this._socket){this._socket=new WebSocket(this._wsUrl);var t=this;this._socket.onmessage=function(s){var n;try{n=JSON.parse(s.data)}catch(i){return void e.util.log("Invalid server message",s.data)}t.emit(o.SocketEventType.Message,n)},this._socket.onclose=function(s){e.util.log("Socket closed."),t._disconnected=!0,t.emit(o.SocketEventType.Disconnected)},this._socket.onopen=function(){t._timeout&&(clearTimeout(t._timeout),setTimeout(function(){t._httpRequest.abort(),t._httpRequest=null},5e3)),t._sendQueuedMessages(),e.util.log("Socket open")}}},i.prototype._startXhrStream=function(t){var s=this;void 0===t&&(t=0);var i=new n(t,this._httpUrl);this._httpRequest=i,i.onError=function(){clearTimeout(s._timeout),s.emit(o.SocketEventType.Disconnected)},i.onSuccess=function(){s._handleStream(i)};try{i.send(),this._setHTTPTimeout()}catch(r){e.util.log("XMLHttpRequest not available; defaulting to WebSockets")}},i.prototype._handleStream=function(t){for(var s=t.getMessages();t.hasBufferedIndices();){var n=t.popBufferedIndex(),i=s[n];try{i=JSON.parse(i)}catch(u){t.buffer.unshift(n);break}this.emit(o.SocketEventType.Message,i)}var r=s[t.index];if(r)if(t.index+=1,t.index===s.length)t.pushIndexToBuffer(t.index-1);else{try{r=JSON.parse(r)}catch(u){return void e.util.log("Invalid server message",r)}this.emit(o.SocketEventType.Message,r)}},i.prototype._setHTTPTimeout=function(){var t=this;this._timeout=setTimeout(function(){if(t._wsOpen())t._httpRequest.abort(),t._httpRequest=null;else{var e=t._httpRequest;t._startXhrStream(e.streamIndex+1),t._httpRequest.previousRequest=e}},this.HTTP_TIMEOUT)},i.prototype._wsOpen=function(){return this._socket&&1==this._socket.readyState},i.prototype._sendQueuedMessages=function(){var t=this._messagesQueue.slice();this._messagesQueue=[];for(var e=0,s=t;e<s.length;e++){var o=s[e];this.send(o)}},i.prototype.send=function(t){if(!this._disconnected)if(this._id)if(t.type){var e=JSON.stringify(t);if(this._wsOpen())this._socket.send(e);else{var s=new XMLHttpRequest,n=this._httpUrl+"/"+t.type.toLowerCase();s.open("post",n,!0),s.setRequestHeader("Content-Type","application/json"),s.send(e)}}else this.emit(o.SocketEventType.Error,"Invalid message");else this._messagesQueue.push(t)},i.prototype.close=function(){!this._disconnected&&this._wsOpen()&&(this._socket.close(),this._disconnected=!0)},i}(s.EventEmitter);exports.Socket=i;
