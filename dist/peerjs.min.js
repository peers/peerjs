...
"use strict";exports.__esModule=!0;var e=require("./util"),t=require("./adapter");exports.Negotiator={pcs:{data:{},media:{}},queue:[]},exports.Negotiator._idPrefix="pc_",exports.Negotiator.startConnection=function(t,o){var r=exports.Negotiator._getPeerConnection(t,o);if(t.pc=t.peerConnection=r,"media"===t.type&&o._stream&&("addStream"in r?r.addStream(o._stream):"addTrack"in r&&o._stream.getTracks().forEach(function(e){r.addTrack(e,o._stream)})),o.originator){if("data"===t.type){var i={};e.util.supports.sctp||(i={reliable:o.reliable});var n=r.createDataChannel(t.label,i);t.initialize(n)}exports.Negotiator._makeOffer(t)}else exports.Negotiator.handleSDP("OFFER",t,o.sdp)},exports.Negotiator._getPeerConnection=function(t,o){exports.Negotiator.pcs[t.type]||e.util.error(t.type+" is not a valid connection type. Maybe you overrode the `type` property somewhere."),exports.Negotiator.pcs[t.type][t.peer]||(exports.Negotiator.pcs[t.type][t.peer]={});var r;exports.Negotiator.pcs[t.type][t.peer];return o.pc&&(r=exports.Negotiator.pcs[t.type][t.peer][o.pc]),r&&"stable"===r.signalingState||(r=exports.Negotiator._startPeerConnection(t)),r},exports.Negotiator._startPeerConnection=function(o){e.util.log("Creating RTCPeerConnection.");var r=exports.Negotiator._idPrefix+e.util.randomToken(),i={};"data"!==o.type||e.util.supports.sctp?"media"===o.type&&(i={optional:[{DtlsSrtpKeyAgreement:!0}]}):i={optional:[{RtpDataChannels:!0}]};var n=new t.RTCPeerConnection(o.provider.options.config,i);return exports.Negotiator.pcs[o.type][o.peer][r]=n,exports.Negotiator._setupListeners(o,n,r),n},exports.Negotiator._setupListeners=function(t,o,r){var i=t.peer,n=t.id,a=t.provider;e.util.log("Listening for ICE candidates."),o.onicecandidate=function(o){o.candidate&&(e.util.log("Received ICE candidates for:",t.peer),a.socket.send({type:"CANDIDATE",payload:{candidate:o.candidate,type:t.type,connectionId:t.id},dst:i}))},o.oniceconnectionstatechange=function(){switch(o.iceConnectionState){case"failed":e.util.log("iceConnectionState is disconnected, closing connections to "+i),t.emit("error",new Error("Negotiation of connection to "+i+" failed.")),t.close();break;case"disconnected":e.util.log("iceConnectionState is disconnected, closing connections to "+i);break;case"completed":o.onicecandidate=e.util.noop}},o.onicechange=o.oniceconnectionstatechange,e.util.log("Listening for data channel"),o.ondatachannel=function(t){e.util.log("Received data channel");var o=t.channel;a.getConnection(i,n).initialize(o)},e.util.log("Listening for remote stream"),o.ontrack=function(t){e.util.log("Received remote stream");var o=t.streams[0],r=a.getConnection(i,n);"media"===r.type&&r.addStream(o)}},exports.Negotiator.cleanup=function(t){e.util.log("Cleaning up PeerConnection to "+t.peer);var o=t.pc;o&&(o.readyState&&"closed"!==o.readyState||"closed"!==o.signalingState)&&(o.close(),t.pc=null)},exports.Negotiator._makeOffer=function(t){var o=t.pc,r=function(r){console.log("created offer",r),e.util.log("Created offer."),!e.util.supports.sctp&&"data"===t.type&&t.reliable&&(r.sdp=Reliable.higherBandwidthSDP(r.sdp));o.setLocalDescription(r).then(function(){return e.util.log("Set localDescription: offer","for:",t.peer),void t.provider.socket.send({type:"OFFER",payload:{sdp:r,type:t.type,label:t.label,connectionId:t.id,reliable:t.reliable,serialization:t.serialization,metadata:t.metadata,browser:e.util.browser},dst:t.peer})}).catch(function(o){return function(o){"OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer"!=o&&(t.provider.emitError("webrtc",o),e.util.log("Failed to setLocalDescription, ",o))}(o)})};console.log(o),o.createOffer(t.options.constraints).then(function(e){return r(e)}).catch(function(o){return function(o){t.provider.emitError("webrtc",o),e.util.log("Failed to createOffer, ",o)}(o)})},exports.Negotiator._makeAnswer=function(t){var o=t.pc,r=function(r){e.util.log("Created answer."),!e.util.supports.sctp&&"data"===t.type&&t.reliable&&(r.sdp=Reliable.higherBandwidthSDP(r.sdp));o.setLocalDescription(r).then(function(){return e.util.log("Set localDescription: answer","for:",t.peer),void t.provider.socket.send({type:"ANSWER",payload:{sdp:r,type:t.type,connectionId:t.id,browser:e.util.browser},dst:t.peer})}).catch(function(o){t.provider.emitError("webrtc",o),e.util.log("Failed to setLocalDescription, ",o)})};o.createAnswer().then(function(e){return r(e)}).catch(function(o){t.provider.emitError("webrtc",o),e.util.log("Failed to create answer, ",o)})},exports.Negotiator.handleSDP=function(o,r,i){i=new t.RTCSessionDescription(i);var n=r.pc;e.util.log("Setting remote description",i);n.setRemoteDescription(i).then(function(){return e.util.log("Set remoteDescription:",o,"for:",r.peer),void("OFFER"===o&&exports.Negotiator._makeAnswer(r))}).catch(function(t){r.provider.emitError("webrtc",t),e.util.log("Failed to setRemoteDescription, ",t)})},exports.Negotiator.handleCandidate=function(o,r){var i=r.candidate,n=r.sdpMLineIndex;o.pc.addIceCandidate(new t.RTCIceCandidate({sdpMLineIndex:n,candidate:i})),e.util.log("Added ICE candidate for:",o.peer)};
