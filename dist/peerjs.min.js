...
},{"./bufferbuilder":"vHo1"}],"iSxC":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("webrtc-adapter");exports.webRTCAdapter=e.webRTCAdapter;
...
"use strict";var r=this&&this.__importStar||function(r){if(r&&r.__esModule)return r;var t={};if(null!=r)for(var e in r)Object.hasOwnProperty.call(r,e)&&(t[e]=r[e]);return t.default=r,t};Object.defineProperty(exports,"__esModule",{value:!0});var t=r(require("js-binarypack")),e=require("./supports"),o={iceServers:[{urls:"stun:stun.l.google.com:19302"},{urls:"turn:0.peerjs.com:3478",username:"peerjs",credential:"peerjsp"}],sdpSemantics:"unified-plan"};exports.util=new(function(){function r(){this.CLOUD_HOST="0.peerjs.com",this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.chunkedMTU=16300,this.defaultConfig=o,this.browser=e.Supports.getBrowser(),this.browserVersion=e.Supports.getVersion(),this.supports=function(){var r,t={browser:e.Supports.isBrowserSupported(),webRTC:e.Supports.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1,sctp:!1};if(!t.webRTC)return t;try{r=new RTCPeerConnection(o),t.audioVideo=!0;var n=void 0;try{n=r.createDataChannel("_PEERJSTEST"),t.data=!0,t.reliable=!!n.ordered,t.sctp=!!r.sctp;try{n.binaryType="blob",t.binaryBlob=!e.Supports.isIOS}catch(a){}}catch(a){}finally{n&&n.close()}}catch(a){}finally{r&&r.close()}return t}(),this.pack=t.pack,this.unpack=t.unpack,this._dataCount=1}return r.prototype.noop=function(){},r.prototype.validateId=function(r){return!r||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(r)},r.prototype.chunk=function(r){for(var t,e=[],o=r.size,n=Math.ceil(o/exports.util.chunkedMTU),a=t=0;a<o;){var i=Math.min(o,a+exports.util.chunkedMTU),s=r.slice(a,i),u={__peerData:this._dataCount,n:t,data:s,total:n};e.push(u),a=i,t++}return this._dataCount++,e},r.prototype.blobToArrayBuffer=function(r,t){var e=new FileReader;e.onload=function(r){r.target&&t(r.target.result)},e.readAsArrayBuffer(r)},r.prototype.blobToBinaryString=function(r,t){var e=new FileReader;e.onload=function(r){r.target&&t(r.target.result)},e.readAsBinaryString(r)},r.prototype.binaryStringToArrayBuffer=function(r){for(var t=new Uint8Array(r.length),e=0;e<r.length;e++)t[e]=255&r.charCodeAt(e);return t.buffer},r.prototype.randomToken=function(){return Math.random().toString(36).substr(2)},r.prototype.isSecure=function(){return"https:"===location.protocol},r}());
},{"js-binarypack":"lHOc","./supports":"I+31"}],"2JJl":[function(require,module,exports) {
