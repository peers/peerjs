...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"0+eO":[function(require,module,exports) {
var binaryFeatures = {};
...
var util_1 = require("./src/peer/util");

var peer_1 = require("./src/peer/peer");

var net_1 = __importDefault(require("./src/app/net"));
...
},{"./src/peer/util":"66CY","./src/peer/peer":"x4E8","./src/app/net":"GYWA"}],"UL96":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.NetEvents = void 0;
var NetEvents;

(function (NetEvents) {
  NetEvents[NetEvents["SetConnections"] = 0] = "SetConnections";
  NetEvents[NetEvents["UpdatePeerId"] = 1] = "UpdatePeerId";
  NetEvents[NetEvents["MsgReceived"] = 2] = "MsgReceived";
  NetEvents[NetEvents["Error"] = 3] = "Error";
})(NetEvents = exports.NetEvents || (exports.NetEvents = {}));
...
var exports_1 = __importDefault(require("../../exports"));

var types_1 = require("./types"); // Peer-to-Peer networking


var Net =
/** @class */
function () {
  function Net(emit, relays) {
    this.connections = [];
    this.peerId = undefined; // TODO: use secure persistant local storage

    this.messages = [];

    if (exports_1.default) {
      // TODO: connect to all provided relays
      if (relays[0]) {
        this.peer = new exports_1.default(relays[0]);
        this.emit = emit;
        /* method bindings */
  ...
  Net.prototype.start = function () {
    var self = this; // Connected to Peer network

    self.peer.on('open', function (peerId) {
      self.peerId = peerId;
      self.emit(types_1.NetEvents.UpdatePeerId, self.peerId);
    }); // Receive
    ...
    self.peer.on('connection', function (conn) {
      ...
      conn.on('error', function (err) {
        self.emit(types_1.NetEvents.Error, err);
      });
    });
  ...
  Net.prototype.connectRemotePeer = function (remotePeerAddress) {
    var self = this;
    var conn = self.peer.connect(remotePeerAddress);
    conn.on('open', function () {
      self.add(conn);
    });
    conn.on('data', function (data) {
  ...
  Net.prototype.add = function (conn) {
    var self = this;

    if (!self.connExists(conn)) {
      self.connections.push(conn);
      self.emit(types_1.NetEvents.SetConnections, self.connections);
    }
  }; // Check if Peer-to-Peer connection exists


  Net.prototype.connExists = function (conn) {
    var self = this;
  ...
  Net.prototype.receiveMessage = function (data) {
    this.messages.push(data);
    this.emit(types_1.NetEvents.MsgReceived, data);
  }; // Send a message


  Net.prototype.sendMessage = function (message, receiver) {
    var self = this;
...
exports.default = Net;
},{"../../exports":"4wlE","./types":"UL96"}],"7QCb":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Kwatafana(domElements) {
    this.domElements = domElements;
  }

  Kwatafana.prototype.emit = function (event, data) {
    switch (event) {
      case types_1.NetEvents.SetConnections:
...
function main(document, console) {
  var app = new Kwatafana({
    peerId: PEER_ID
  });
  var net = new net_1.default(app.emit, RELAYS);
}
